            ...
            <div className="row g-4">
              <div className="col-12">
                <div className="text-center mx-auto" style={{maxWidth: "700px"}}>
                  ...
                  <p className="mb-4 text-dark">The contact form is currently inactive. Get a functional and working contact form with Ajax & PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <a href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
                </div>
              </div>
                  ...
                  <input type="text" className="w-100 form-control border-0 py-3 mb-4" placeholder="Your Name"/>
                    ...
                    <div className="col-lg-5">
                      <div className="d-flex p-4 rounded mb-4 bg-white">
                        ...
                        <div>
                          <h4>Address</h4>
                          <p className="mb-2 text-dark">123 Street New York.USA</p>
                        </div>
                      </div>
                      <div className="d-flex p-4 rounded mb-4 bg-white">
                      ...
                      <div className="d-flex p-4 rounded bg-white">
                        ...
                        <div>
                          <h4>Telephone</h4>
                          <p className="mb-2 text-dark">(+012) 3456 7890</p>
                        </div>
                      </div>
                    </div>
                  </div>
