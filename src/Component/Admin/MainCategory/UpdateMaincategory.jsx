    ...
    <>
      ...
      <div className="container-fluid page-header py-5">
        ...
        <ol className="breadcrumb justify-content-center mb-0">
          ...
          <li className="breadcrumb-item active text-white">Update Category</li>
        </ol>
      </div>
      ...
      <div className="container-fluid my-3" >
        <div className="row">
          ...
          <div className="col-md-9">
            <h5 className="bg-primary text-center text-light p-2">Update Category </h5>
            <form onSubmit={postData}>
              <div className="mb-3 text-dark">
                <label>Name<span className="text-danger">*</span></label>
                <input type="text" name='name' onChange={getInputData} className="form-control text-dark" value={name} placeholder='Maincategory' />
