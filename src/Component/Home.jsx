  ...
  return (
    <>
            ...
            <div className="col-md-6 col-lg-3">
              <div className="featurs-item text-center rounded bg-light p-4">
                ...
                <div className="featurs-content text-center">
                  <h5>Free Shipping</h5>
                  <p className="mb-0 text-dark">Free on order over $300</p>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-3">
              <div className="featurs-item text-center rounded bg-light p-4">
                ...
                <div className="featurs-content text-center">
                  ...
                  <p className="mb-0 text-dark">100% security payment</p>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-3">
              <div className="featurs-item text-center rounded bg-light p-4">
                ...
                <div className="featurs-content text-center">
                  <h5>30 Day Return</h5>
                  <p className="mb-0 text-dark">30 day money guarantee</p>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-3">
              <div className="featurs-item text-center rounded bg-light p-4">
                ...
                <div className="featurs-content text-center">
                  <h5>24/7 Support</h5>
                  <p className="mb-0 text-dark">Support every time fast</p>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div className="row g-4">
                      <div className="col-md-6 col-lg-4 col-xl-3">
                        <div className="rounded position-relative fruite-item">
                          ...
                          <div className="p-4 text-dark border border-secondary border-top-0 rounded-bottom">
                            <h4>Grapes</h4>
      ...
      <div className="container-fluid vesitable py-5">
        <div className="container py-5">
          <h1 className="mb-0 text-dark">Fresh Organic Vegetables</h1>
          <div className="owl-carousel vegetable-carousel justify-content-center">
            <div className="border border-primary rounded position-relative vesitable-item">
              ...
              <div className="p-4 text-dark rounded-bottom">
                <h4>Parsely</h4>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                <div className="d-flex justify-content-between flex-lg-wrap">
                  <p className="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
        ...
        <div className="container py-5">
          <div className="row g-4 align-items-center">
            <div className="col-lg-6">
              <div className="py-4">
                <h1 className="display-3 text-dark">Fresh Exotic Fruits</h1>
      ...
      <div className="container-fluid py-5">
        <div className="container py-5">
          <div className="text-center text-dark mx-auto mb-5" style={{ maxWidth: "700px" }}>
            <h1 className="display-4">Bestseller Products</h1>
            <p>Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable.</p>
          </div>
          <div className="row g-4">
            <div className="col-lg-6 col-xl-4">
              <div className="p-4 text-dark rounded bg-light">
            ...
            <div className="testimonial-item img-border-radius bg-light rounded p-4">
              <div className="position-relative">
                ...
                <div className="mb-4 pb-4 border-bottom border-secondary">
                  <p className="mb-0 text-dark">Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,
                  </p>
                </div>
