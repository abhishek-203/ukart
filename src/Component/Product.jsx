      ...
      <div className="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-fullscreen">
          <div className="modal-content rounded-0">
            ...
            <div className="modal-body d-flex text-dark align-items-center">
              <div className="input-group w-75 mx-auto d-flex">
                <input type="search" className="form-control p-3" placeholder="keywords" aria-describedby="search-icon-1" />
                <span id="search-icon-1" className="input-group-text p-3"><i className="text-dark fa fa-search"></i></span>
              </div>
            </div>
          </div>
          ...
          <div className="row g-4 mb-5">
            <div className="col-lg-8 col-xl-9">
              <div className="row g-4">
                ...
                <div className="col-lg-6">
                  ...
                  <p className="mb-3 text-dark">Category: Vegetables</p>
                  <h5 className="fw-bold mb-3">3,35 $</h5>
                  <div className="d-flex text-dark text-dark mb-4">
                  ...
                  <p className="text-dark mb-4">The generated Lorem Ipsum is therefore always free from repetition injected humour, or non-characteristic words etc.</p>
                  <p className="text-dark mb-4">Susp endisse ultricies nisi vel quam suscipit. Sabertooth peacock flounder; chain pickerel hatchetfish, pencilfish snailfish</p>
                  <div className="input-group quantity mb-5" style={{width: "100px"}}>
                    <div className="input-group-btn">
                      <button className="btn btn-sm btn-minus rounded-circle bg-light border" >
                        <i className="text-dark fa fa-minus"></i>
                      </button>
                    </div>
                    <input type="text" className="form-control form-control-sm text-center text-dark border-0" value="1" />
                    <div className="input-group-btn">
                      <button className="btn btn-sm btn-plus rounded-circle bg-light border">
                        <i className="text-dark fa fa-plus"></i>
                      </button>
                    </div>
                  </div>
                  <a href="#" className="btn border border-secondary rounded-pill px-4 py-2 text-dark mb-4 text-primary"><i className="text-dark fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                </div>
                <div className="col-lg-12">
                  ...
                  <div className="tab-content mb-5 text-dark">
                      ...
                      <div className="d-flex">
                        ...
                        <div className="">
                          ...
                          <div className="d-flex text-dark justify-content-between">
                            <h5>Jason Smith</h5>
                            <div className="d-flex text-dark mb-3">
                              <i className="fa fa-star text-secondary"></i>
                              <i className="fa fa-star text-secondary"></i>
                              <i className="fa fa-star text-secondary"></i>
                              <i className="fa fa-star text-secondary"></i>
                ...
                <form action="#">
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-lg-12">
                      <div className="d-flex text-dark justify-content-between py-3 mb-5">
                        <div className="d-flex text-dark align-items-center">
                          <p className="mb-0 me-3 text-dark">Please rate:</p>
            ...
            <div className="col-lg-4 col-xl-3">
              <div className="row g-4 fruite">
                <div className="col-lg-12">
                  <div className="input-group w-100 mx-auto d-flex text-dark text-dark mb-4">
                    <input type="search" className="form-control p-3" placeholder="keywords" aria-describedby="search-icon-1" />
                    <span id="search-icon-1" className="input-group-text p-3"><i className="text-dark fa fa-search"></i></span>
                  </div>
                  <div className="text-dark mb-4">
                    ...
                    <ul className="list-unstyled fruite-categorie">
                      <li>
                        <div className="d-flex text-dark justify-content-between fruite-name">
                ...
                <div className="col-lg-12">
                  ...
                  <div className="d-flex text-dark align-items-center justify-content-start">
                  ...
                  <div className="d-flex text-dark justify-content-center my-4">
            ...
            <div className="owl-carousel vegetable-carousel justify-content-center">
              <div className="border border-primary rounded position-relative vesitable-item">
                ...
                <div className="p-4 pb-0 rounded-bottom">
                  ...
                  <div className="d-flex text-dark justify-content-between flex-lg-wrap">
                    <p className="text-dark fs-5 fw-bold">$4.99 / kg</p>
                    <a href="#" className="btn border border-secondary rounded-pill px-3 py-1 text-dark mb-4 text-primary"><i className="text-dark fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                  </div>
                </div>
              </div>
              <div className="border border-primary rounded position-relative vesitable-item">
                ...
                <div className="p-4 pb-0 rounded-bottom">
                  ...
                  <div className="d-flex text-dark justify-content-between flex-lg-wrap">
                    <p className="text-dark fs-5 fw-bold">$4.99 / kg</p>
                    <a href="#" className="btn border border-secondary rounded-pill px-3 py-1 mb-4 text-primary"><i className="text-secondary fa fa-shopping-bag me-2"></i> Add to cart</a>
                  </div>
                </div>
              </div>
              <div className="border border-primary rounded position-relative vesitable-item">
