    ...
    <>
      ...
      <div className="container-fluid py-5">
        <div className="container py-5">
                ...
                <tr>
                  ...
                  <td>
                    <div className="input-group quantity mt-4" style={{width: "100px"}}>
                      ...
                      <input type="text" className="form-control form-control-sm text-center border-0 text-dark" value="1"/>
                        <div className="input-group-btn">
          ...
          <div className="mt-5">
            <input type="text" className="border-0 text-dark border-bottom rounded me-5 py-3 mb-4" placeholder="Coupon Code"/>
